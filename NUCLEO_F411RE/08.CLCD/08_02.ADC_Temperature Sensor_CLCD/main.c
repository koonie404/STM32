...
static void MX_ADC1_Init(void)
{
  ...
  */
  ...
  sConfig.SamplingTime = ADC_SAMPLETIME_239CYCLES_5;  // 샘플링 시간 증가
...
static void MX_I2C1_Init(void)
{
  ...
  hi2c1.Init.DutyCycle = 0x00000000U;  // I2C_DUTYCYCLE_2 대체
  hi2c1.Init.OwnAddress1 = 0;
  hi2c1.Init.AddressingMode = 0x00004000U;  // I2C_ADDRESSINGMODE_7BIT 대체
  hi2c1.Init.DualAddressMode = 0x00000000U;  // I2C_DUALADDRESS_DISABLE 대체
  hi2c1.Init.OwnAddress2 = 0;
  hi2c1.Init.GeneralCallMode = 0x00000000U;  // I2C_GENERALCALL_DISABLE 대체
  hi2c1.Init.NoStretchMode = 0x00000000U;  // I2C_NOSTRETCH_DISABLE 대체
